...
public class ExamMultipleChoiceSwipeActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    MultipleChoiceTopic newTopic = (MultipleChoiceTopic)(intent.getSerializableExtra(TopicSelectionActivity.TOPIC));
	    
	    if (newTopic == null){
	    	// can't get newTopicId
	    	AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mViewPager.getContext());
		...
		currentTopic.RemainingTime = currentTopic.Time;
	}
	...
	private void toCountDown(){
		updateTimerMethod = new Runnable() {
			public void run() {
				cdtMain = new CountDownTimer(currentTopic.RemainingTime, 1000) {
					
					@Override
					public void onTick(long millisUntilFinished) {
						currentTopic.RemainingTime = millisUntilFinished;
						setActionBarTitle(Misc.clockTextFromMilliseconds(millisUntilFinished));
					}
					
					@Override
					public void onFinish() {
						setActionBarTitle(Misc.clockTextFromMilliseconds(0));
	    ...
	    myHandler.postDelayed(updateTimerMethod, 100);
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.exam_multiple_choice_swipe, menu);
		return true;
	}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			final View rootView = inflater.inflate(
					R.layout.fragment_exam_multiple_choice_swipe, container, false);
			TextView textView = (TextView) (rootView
					.findViewById(R.id.section_label));
			textView.setText(Integer.toString(getArguments().getInt(
					ARG_SECTION_NUMBER)) + "/" + String.valueOf(questions.size()));
			
			MultipleChoiceQuestion question = questions.get(getArguments().getInt(ARG_SECTION_NUMBER) - 1);
			
			tvQuestionText = (TextView)(rootView.findViewById(R.id.tvQuestionText));
			...
			for(Choice choice : question.Choices){
				...
				rdo.setChecked(question.SelectedId != View.NO_ID && question.SelectedId == rdo.getId());
				...
				rgChoices.addView(ruler, new ViewGroup.LayoutParams( ViewGroup.LayoutParams.MATCH_PARENT, 2));
			}
    ...
    private class LoadViewTask extends AsyncTask<Void, Integer, Void>{  
        ...
        {  
            ...
            progressDialog = new ProgressDialog(ExamMultipleChoiceSwipeActivity.this); 
            progressDialog.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
            progressDialog.setTitle("Loading..."); 
            progressDialog.setMessage("Loading topic data, please wait...");
        ...
        protected Void doInBackground(Void... params)  
        {
        	...
        	{ 
        		...
        		for (int i = 0; i < questionCount; i++){
        			...
        			question.Choices.addAll(dbHelper.getChoicesOfQuestion(question));
